...
pub(crate) struct Config {
    ...
    #[structopt(short = "w", long = "uplink_bandwidth", parse(try_from_str = "crate::config::try_non_zero_usize_from_str"))]
...
mod test {
    ...
    fn valid_args1() {
        ...
        assert_eq!(100_000_000, usize::from(config.uplink_bandwidth));
